...
const SEED_SPOTS = [
  ...
  ...(typeof PLANO_OUT_SPOTS !== "undefined" ? PLANO_OUT_SPOTS : []),   // Plano nature + hangouts (701+)
  ...(typeof PLANO_FOOD_SPOTS !== "undefined" ? PLANO_FOOD_SPOTS : []),  // Plano international food (801+)
...
SEED_SPOTS.forEach(s => {
  window.SPOT_EXTRAS[s.id] = { photos: s.photos, reviewUrl: s.reviewUrl, rating: s.rating, photoCredit: s.photoCredit, embeds: s.embeds };
});
