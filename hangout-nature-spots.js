...
const HANGOUT_NATURE_SPOTS = [
  ...
  },
  {
    ...
    photos: ["img/real/spot-304.jpg"],
    photoCredit: { by: "ChezArcade", license: "YouTube", url: "https://www.youtube.com/watch?v=WneXyu9mnDs" },
    cat: "hangout",
  ...
  },
  {
    ...
    photoCredit: { by: "Jackilometresan", license: "CC0", url: "https://commons.wikimedia.org/wiki/File:A_wooded_boardwalk_trail_in_Oak_Point_Park_in_Plano,_Texas,_USA.jpg" },
    cat: "nature",
  ...
  },
  {
    ...
    photoCredit: { by: "Robert Nunnally", license: "CC BY 2.0", url: "https://commons.wikimedia.org/wiki/File:Spring_Creek_Forest_Preserve.jpg" },
    cat: "nature",
